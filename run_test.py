...
def parse_args():
    ...
    parser.add_argument("-memo",       type=str,               default='benchmark_1217_11_3_1')
    parser.add_argument("-old_memo",   type=str,               default='benchmark_1217_11')
    parser.add_argument("-model",       type=str,               default="AdvancedColight") # AdvancedMPLight
    parser.add_argument("-old_dir",    type=str,               default='anon_3_4_jinan_real_2500.json_12_17_19_10_11')
    parser.add_argument("-old_round",  type=str,                default="round_70")
...
class Testor:
    ...
    def main(self):
        rounds = ["round_" + str(i) for i in range(70, 80)]
    ...
    def run(self):
        ...
        while not done and step_num < int(self.dic_traffic_env_conf["RUN_COUNTS"]/self.dic_traffic_env_conf["MIN_ACTION_TIME"]):
            ...
            action_list = self.agent.choose_action(step_num, state)
